    ...
    return (
      <View style={{backgroundColor: 'white'}}>
        <View
          ...
          />
          <Text style={{fontSize: 20, marginTop: 9, paddingStart: 30}}>
        ...
        <View style={{height: 0.8, backgroundColor: 'gray', marginTop: 20}} />
        <ScrollView
          refreshControl={
            <RefreshControl
              refreshing={false}
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <View
                  ...
                  <Text
                    style={
                      this.state.isLoaded ? styles.loaded : {display: 'none'}
                    }>
                    {item.name}
                  </Text>
                </View>
