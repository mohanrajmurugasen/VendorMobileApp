...
import { View, Text, ScrollView, StyleSheet, TouchableHighlight, TextInput, Image, TouchableOpacity } from 'react-native';
    ...
    return(
        ...
        <ScrollView style={{paddingHorizontal:15,backgroundColor:"white"}}>
            <View style={{paddingBottom:15}}>
                ...
                <Text style={[styles.txt2,styles.center]}>12A, Jln Masjid Negeri, 11600 George Town, Pulau Pinang</Text>
            </View>
        ...
        <Card style={{
           ...
           >
               <Text style={{fontSize:18,color:"white",textAlign:"center"}}>Save this location</Text>
           </TouchableOpacity>
           <TouchableOpacity
           onPress={()=>navigation.navigate('Tabs')}
           style={{backgroundColor:"#dad7d7",paddingVertical:8,marginTop:7}}
           >
               <Text style={{fontSize:18,color:"#4a4a4a",textAlign:"center"}}>Skip and add later</Text>
           </TouchableOpacity>
        </Card>
        </View>
    )
